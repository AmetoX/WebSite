...
<h2>1. Nail Prep </h2>
	<?php $galerii = array(
        ...
        Another trick you can do is attach the bottom corners together and then put them on the finger. Look at it from the side so you know it's straight and not angled up or down. Pinch the tip of the Nail Form depending on what shape and length you're going for.", "gallery_iamge" => "nailforms.jpg" ),
		array("Title" => "3. Apply Gel On The Nail Forms", "Title_description" => " Now that the application part is over, it's time for you to be creative by applying your chosen medium ( acrylic, builder gel, and sculpture gel) onto your nails, using the vertical lines to guide the length and horizontal lines to guide the width.", "gallery_iamge" => "formswith_gel.jpg" ),
